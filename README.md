...
> **Status:** `1.0.0-beta.10` — pre-release. Not yet recommended for production.
...
| Custom fields | Plugin territory | **Secure Custom Fields** integrated into core |
...
- `$dmpress_version` (**`1.0.0-beta.10`**) is the product version shown to users.
