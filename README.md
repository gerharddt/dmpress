...
> **Status:** `1.0.0-beta.28` — pre-release. Not yet recommended for production.
...
| Themes | `style.css` + PHP templates, parent/child | A single `theme.json` manifest; no child themes |
...
- `$dmpress_version` (**`1.0.0-beta.28`**) is the product version shown to users.
