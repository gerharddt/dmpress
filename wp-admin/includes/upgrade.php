...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			__( 'Welcome to DMPress. This is your first post. Edit or delete it, then start writing!' ) .
			'</p>';
		}
		...
		$first_comment_author = ! empty( $first_comment_author ) ? $first_comment_author : __( 'A DMPress Commenter' );
		$first_comment_email  = ! empty( $first_comment_email ) ? $first_comment_email : 'commenter@example.com';
		$first_comment_url    = ! empty( $first_comment_url ) ? $first_comment_url : '';
...
Commenter avatars come from <a href="%s">Gravatar</a>.'
		...
		/*
		 * DMPress: only create the Sample Page and Privacy Policy page when a
		 * 'page' post type is registered. By default DMPress has no page type.
		 */
		...
		if ( empty( $first_page ) ) {
			...
			$first_page .= sprintf(
				...
				__( 'As a new DMPress user, you should go to <a href="%s">your dashboard</a> to delete this page and create new pages for your content. Have fun!' ),
				admin_url()
			);
			$first_page .= '</p>';
		}
