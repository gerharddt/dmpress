	...
	<p class="description">
		<?php
			printf(
				...
				__( 'The Site Icon is what you see in browser tabs, bookmark bars, and within the DMPress mobile apps. It should be square and at least <code>%1$s by %2$s</code> pixels.' ),
				512,
				512
			);
		?>
