...
<head>
	...
	<title><?php _e( 'DMPress &rsaquo; Installation' ); ?></title>
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<p class="step"><?php submit_button( __( 'Install DMPress' ), 'large', 'Submit', false, array( 'id' => 'submit' ) ); ?></p>
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed DMPress. To reinstall please clear your old database tables first.' ) . '</p>' .
...
switch ( $step ) {
	...
	case 1: // Step 1, direct link or from language chooser.
		...
		?>
<h1><?php _ex( 'Welcome', 'Howdy' ); ?></h1>
<p><?php _e( 'Welcome to the famous five-minute DMPress installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful data management platform in the world.' ); ?></p>
