...
if ( file_exists( ABSPATH . 'wp-config-sample.php' ) ) {
	...
	wp_die(
		sprintf(
			...
			__( 'Sorry, I need a %s file to work from. Please re-upload this file to your DMPress installation.' ),
...
if ( @file_exists( ABSPATH . '../wp-config.php' ) && ! @file_exists( ABSPATH . '../wp-settings.php' ) ) {
	wp_die(
		'<p>' . sprintf(
			/* translators: 1: wp-config.php, 2: install.php */
			__( 'The file %1$s already exists one level above your DMPress installation. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href="%2$s">installing now</a>.' ),
			'<code>wp-config.php</code>',
			'install.php'
		) . '</p>',
		409
...
<head>
	...
	<title><?php _e( 'DMPress &rsaquo; Setup Configuration File' ); ?></title>
...
<p><?php _e( 'Welcome to DMPress. Before getting started, you will need to know the following items.' ); ?></p>
<ol>
	<li><?php _e( 'Database name' ); ?></li>
	<li><?php _e( 'Database username' ); ?></li>
	<li><?php _e( 'Database password' ); ?></li>
	<li><?php _e( 'Database host' ); ?></li>
	<li><?php _e( 'Table prefix (if you want to run more than one DMPress in a single database)' ); ?></li>
</ol>
<p>
		<?php
		printf(
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td><input name="dbname" id="dbname" type="text" aria-describedby="dbname-desc" size="25" placeholder="dmpress"<?php echo $autofocus; ?> />
			<p id="dbname-desc"><?php _e( 'The name of the database you want to use with DMPress.' ); ?></p></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="prefix" id="prefix" type="text" aria-describedby="prefix-desc" value="dmp_" size="25" />
			<p id="prefix-desc"><?php _e( 'If you want to run multiple DMPress installations in a single database, change this.' ); ?></p></td>
		</tr>
	</table>
		<?php
		if ( isset( $_GET['noapi'] ) ) {
...
<p><?php _e( 'All right, sparky! You&#8217;ve made it through this part of the installation. DMPress can now communicate with your database. If you are ready, time now to&hellip;' ); ?></p>
