...
require ABSPATH . WPINC . '/block-compat.php';
...
// DMPress: Secure Custom Fields is integrated into core and always loaded.
define( 'ACF_PATH', ABSPATH . WPINC . '/scf/' );
define( 'ACF_BASENAME', 'scf/secure-custom-fields.php' );
