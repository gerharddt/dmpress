...
class WP_Http {
	 ...
	 *                                             Default 'WordPress/' . get_bloginfo( 'version' ) . '; DMPress/' . $GLOBALS['dmpress_version'] . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @param string $url        The request URL.
			 */
			'user-agent'          => apply_filters( 'http_headers_useragent', 'WordPress/' . get_bloginfo( 'version' ) . '; DMPress/' . $GLOBALS['dmpress_version'] . '; ' . get_bloginfo( 'url' ), $url ),
			/**
