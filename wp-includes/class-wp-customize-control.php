	...
	protected function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'dropdown-pages':
				...
				echo $dropdown;
				?>
				<?php if ( $this->allow_addition && post_type_exists( 'page' ) && current_user_can( 'publish_pages' ) && current_user_can( 'edit_theme_options' ) ) : // Currently tied to menus functionality. ?>
