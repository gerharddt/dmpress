...
final class WP_Customize_Manager {
			...
			new WP_Customize_Site_Icon_Control(
				...
				array(
					...
					'description' => sprintf(
						...
						'<p>' . __( 'The Site Icon is what you see in browser tabs, bookmark bars, and within the DMPress mobile apps. It should be square and at least <code>%1$s by %2$s</code> pixels.' ) . '</p>',
						512,
						512
					),
					'section'     => 'title_tagline',
	...
	public function has_published_pages() {
		...
		// get_pages() returns false when no hierarchical 'page' type is registered
		// (the default in DMPress); cast so count() never receives a non-array.
		return 0 !== count(
			(array) get_pages(
				array(
					'number'       => 1,
