...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'html':
			$gen = '<meta name="generator" content="DMPress ' . esc_attr( $GLOBALS['dmpress_version'] ) . '">';
			break;
		case 'xhtml':
			$gen = '<meta name="generator" content="DMPress ' . esc_attr( $GLOBALS['dmpress_version'] ) . '" />';
			break;
		case 'atom':
			$gen = '<generator uri="https://wordpress.org/" version="' . esc_attr( $GLOBALS['dmpress_version'] ) . '">DMPress</generator>';
			break;
		case 'rss2':
		...
		case 'rdf':
			...
			break;
		case 'comment':
			$gen = '<!-- generator="DMPress/' . esc_attr( $GLOBALS['dmpress_version'] ) . '" -->';
			break;
		case 'export':
			$gen = '<!-- generator="DMPress/' . esc_attr( $GLOBALS['dmpress_version'] ) . '" created="' . gmdate( 'Y-m-d H:i' ) . '" -->';
			break;
	}
