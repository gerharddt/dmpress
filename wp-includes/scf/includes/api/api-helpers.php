...
function acf_get_wp_reserved_terms() {
	/*
	 * DMPress: 'page' and 'post' are intentionally NOT reserved here. Neither is a
	 * built-in post type in DMPress any more, so the Content-Type Builder must be
	 * able to define post types keyed 'page' and 'post' ('post' ships as a default
	 * Content-Type Builder entry that admins may delete).
	 *
	 * Note that 'page' remains a core query var (`?page=N` pagination), so a
	 * recreated 'page' post type should use 'query_var' => false (or a custom
	 * query var), as the original built-in did, to avoid colliding with pagination.
	 */
	return array( 'action', 'attachment', 'attachment_id', 'author', 'author_name', 'calendar', 'cat', 'category', 'category__and', 'category__in', 'category__not_in', 'category_name', 'comments_per_page', 'comments_popup', 'custom', 'customize_messenger_channel', 'customized', 'cpage', 'day', 'debug', 'embed', 'error', 'exact', 'feed', 'fields', 'hour', 'link', 'link_category', 'm', 'minute', 'monthnum', 'more', 'name', 'nav_menu', 'nonce', 'nopaging', 'offset', 'order', 'orderby', 'p', 'page_id', 'paged', 'pagename', 'pb', 'perm', 'post__in', 'post__not_in', 'post_format', 'post_mime_type', 'post_status', 'post_tag', 'post_type', 'posts', 'posts_per_archive_page', 'posts_per_page', 'preview', 'robots', 's', 'search', 'second', 'sentence', 'showposts', 'static', 'status', 'subpost', 'subpost_id', 'tag', 'tag__and', 'tag__in', 'tag__not_in', 'tag_id', 'tag_slug__and', 'tag_slug__in', 'taxonomy', 'tb', 'term', 'terms', 'theme', 'themes', 'title', 'type', 'types', 'w', 'withcomments', 'withoutcomments', 'year' );
}
